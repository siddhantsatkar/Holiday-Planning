...
<body>
	...
	<div class="container text-center">
		...
		<br />
		<p align="right">
			<font color="red"><h3>The place you entered does not
					exists.. Try again..!!</h3></font>
		</p>
		<br />

		<FORM NAME="radioLinks">
			<INPUT TYPE="radio" NAME="pickme" id="Countries" checked=""
				onClick="document.location='ta_user.jsp';" /> Country <INPUT
				TYPE="radio" NAME="pickme" id="RoundTrip"
				onClick="document.location='ta_region_user.jsp';" /> Region

		</FORM>

		<form action="TASearch" method="post" class="form-inline">
			<div class="form-group">
				<label class="control-label" for="usr">Country:</label> <input
